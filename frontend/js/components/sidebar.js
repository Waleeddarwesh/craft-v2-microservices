...
const Sidebar = (() => {
    ...
    const NAV_ITEMS = [
        ...
        {
            section: window.t('Management'), items: [
                { route: 'users', label: window.t('Users'), icon: 'users' },
                { route: 'payments', label: window.t('Payments'), icon: 'payments' },
                { route: 'withdrawals', label: window.t('Withdrawals'), icon: 'withdrawals', badgeKey: 'pending_withdrawals' },
        ...
        },
        {
            section: window.t('Content'), items: [
                ...
                { route: 'product-moderation', label: window.t('Product Moderation'), icon: 'products' },
                { route: 'reviews', label: window.t('Reviews'), icon: 'reviews' },
                { route: 'notifications', label: window.t('Notifications'), icon: 'notifications' },
            ]
        },
        {
            section: window.t('Analytics'), items: [
                { route: 'reports', label: window.t('Reports'), icon: 'reports' },
                { route: 'reconciliation', label: window.t('Reconciliation'), icon: 'reports' },

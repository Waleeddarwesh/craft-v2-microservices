        ...
        if user.is_authenticated and hasattr(user, 'delivery'):
            ...
            if not delivery.DeliveryContract and not delivery.DeliveryIdentity:
             ...
             async_to_sync(channel_layer.group_send)(
              ...
              "message": _("upload your contract please .")
               }
               )
             return False
            if not delivery.accepted_delivery:
                raise ValidationError(_("Your delivery account has not been accepted yet.the adminstrators will accept your documents soon "))
